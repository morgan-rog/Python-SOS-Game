...
#         return self.assertEqual(self.game.get_cell_button_value(3,5), self.game.red_player.option.get())
...
#         return self.assertEqual(self.game.get_cell_button_value(4,4), self.game.blue_player.option.get())
